...
def upgrade() -> None:
    ...
    item_type = sa.Enum("sticker", "gif", "artifact", "avatar", "frame", "card", name="item_type")
    ...
    trade_status = sa.Enum("open", "cancelled", "completed", name="trade_status")
    ...
    op.create_table(
        ...
        sa.Column("vusdt", sa.Integer(), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("offer_item", sa.String(length=128), nullable=False),
        sa.Column("request_item", sa.String(length=128), nullable=False),
